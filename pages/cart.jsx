                ...
                <DivCenter>
                    <Wrapper>
                        <Box>
                            ...
                            <p>Wyślemy tobie powiadomienie email, kiedy twoje zamówienie będzie gotowe</p>
                        </Box>
                    </Wrapper>
                </DivCenter>
                </Layout>
                            ...
                            <Table>
                                ...
                                {products.map(product => (
                                    <tr key={product._id}>
                                        ...
                                        <td>
                                            <Button size="s" usage="quantity"
                                                onClick={() => quantitySub(product._id)}>-</Button>
                                            <QuantityLabel>
                                                {cartProducts.filter(id => id === product._id).length}
                                            </QuantityLabel>
                                            <Button size="s" usage="quantity"
                                                onClick={() => quanitityAdd(product._id)}>+</Button>
                                        </td>
                                        <td>
                                            {cartProducts.filter(id => id === product._id).length * product.price} zł
                                        </td>
                                    </tr>
                                ))}
                                <tr>
