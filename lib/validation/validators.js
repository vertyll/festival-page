...
export const validateCity = (city) => {
  ...
  // można dodać więcej reguł zależnie od specyficznych wymagań
  return null;
};
...
export const validateStreetAddress = (streetAddress) => {
  ...
  // można dodać więcej reguł zależne od specyficznych wymagań, np. czy adres zawiera numer domu/mieszkania
  return null;
};
...
export const validateCountry = (country) => {
  ...
  // można również sprawdzić, czy wartość należy do listy akceptowanych krajów, jeśli jest taka potrzeba
  return null;
};
